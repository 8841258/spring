...
<div class="row">
	<div class="col-lg-6">
		<form role="form" method="POST" action="/emp/updateForm">
			...
			<button class="btn btn-outline btn-info">삭제</button>
		</form>
	</div>
</div>
