...
<%@ include file="/WEB-INF/views/includes/header.jsp"%>
	<!-- context-name이 없는 경우 /, 있는 경우(/app) ./ or /app/resources~ -->
...
<script type="text/javascript" >
	...
	function userDelete() {
		...
		$('body').on('click','#btnDelete',function(){
			...
			let userId2 = $(this).closest('tr').data("userid");
...
/* 			var id = $('input:text[name="id"]').val();
			...
			$.ajax({ 
			    url: "users",  
			    type: 'POST',  
			    dataType: 'json', //responseType
			    //data: JSON.stringify({ id: id, name:name,password: password, role: role }),
			    data : JSON.stringify($("#form1").serializeObject()), //serialize()는 query string, serializeObject()는 json 타입으로.
			    contentType: 'application/json', //requestType
